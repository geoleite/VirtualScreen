 ...
 * Always resizes the image to fit the size of the component, even if it
 * distorts the aspect ratio.<br> Used by com.mindprod.networkcam.NetworkCam
 *
 * @author Roedy Green, Canadian Mind Products
 * @version 1.2, 2007-04-20
 * @see ImageViewer
 */
public final class ResizingImageViewer extends Component {
     ...
     *
     * @param image the Image to be displayed, See the Java glossary under Image
     *              for ways to create an Image.
     */
