/* BigDate
  copyright (c) 1997-2007 Roedy Green, Canadian Mind Products Shareware
  ...
  1.9 1997-12-17 - add documenation on how to convert to the British
  ...
  2.9 1999-09-08add sample isHoliday implemenation to TestDate. add
 ...
 * forms internally. If you store one, it creates the other.
 * <p/>
 * The standard Sun Date won't handle dates prior to 1970 among other problems.
 * BigDate handles dates 999,999 BC Jan 1 to 999,999 AD Dec 31, 0 = 1970 Jan 1.
 * <p/>
 * Are the following quirks of the calendar considered in this code?<br> <dl
 * compact> <dt>yes</dt> <dd>1900 is not a leap year (mod 100).</dd>
 * <dt>yes</dt> <dd>2000 is a leap year (mod 400).</dd> <dt>yes</dt> <dd>The 10
 * missing days in 1582 October. (Pope Gregory's correction) 1582 Oct 5 to 1582
 * Oct 14 never happened.</dd> <dt>partly</dt> <dd>Britain and its territories
 ...
 * 999,999BC.</dd> <dt>no</dt> <dd>leap seconds.</dd></dl>
 * <p/>
 * Normally all you need is one BigDate object that you use for all
 * interconversions with set(ordinal), set(yyy,mm,dd) and getOrdinal(),
 * getYYYY(), getMM(), getDD().
 * <p/>
 * java.util.Date has some odd habits, using 101 to represent the year 2001, and
 * 11 to represent December. BigDate is more conventional. You use 2001 to
 * represent the year 2001 and 12 to represent December.
 * <p/>
 * BigDate implements proleptic Gregorian and Julian calendars. That is, dates
 * are computed by extrapolating the current rules indefinitely far backward and
 ...
 * avoid confusion, this calendar always uses January 1.
 * <p/>
 * TODO Future enhancements: - handle time, and timezones, interconversion with
 * GregorianCalendar dates.
 *
 * @author Roedy Green, Canadian Mind Products
 * @version 4.9, 2006-03-04 see com.mindprod.holidays.Holidays for Holiday
 *          handling.
 *          <p/>
 */
public final class BigDate implements Cloneable, Serializable, Comparable {
     ...
     * like getOrdinal or getDD. You always get the date the object was
     * created.
     *
     ...
     * @param asof      usually today, the day you want the age as of. asof must
     *                  come after birthDate to get a meaningful result.
     *
    ...
    public static String getCopyright()
        {
        return "BigDate 4.9 freeware copyright (c) 1997-2007 Roedy Green, Canadian Mind Products, http://mindprod.com roedyg@mindprod.com";
        }
     ...
     * Thursday...
     *
     * @param which     1=first 2=second 3=third 4=fourth 5=last (might be 4th
     *                  or 5th)
     * @param dayOfWeek 0=Sunday 1=Monday 2=Tuesday 3=Wednesday 4=Thursday
     *                  5=Friday 6=Saturday WARNING: not compatible with
     *                  1=Calendar.SUNDAY.
     * @param yyyy      year of interest.
     * @param mm        month 1 to 12 (not 0 to 11 as in Sun's Date)
     ...
     *
     * @param prolepticJulianDay days since 4713 BC Jan 1 noon. Such numbers
     *                           usually arise in astronomical calculation. You
     *                           don't need to concern yourself with the
     *                           strangeness of the Julian calendar, just its
     *                           simple day numbering. BEWARE! after adjusting
     *                           for noon, fractional parts are discarded.
     *                           BigDate tracks only dates, not dates and times.
     *                           e.g. 2000-03-20 noon is 2,451,624 in proleptic
     *                           day numbers. 1970-1-1 is 2,440,588 1600-1-1 is
     *                           2,305,448 1500-1-1 is 2,268,933 0001-1-1 is
     *                           1,721,424 -0001-12-31 is 1,721,423 -0006-1-1 is
     ...
     * Copy constructor
     *
     * @param b an existing BigDate object to use as a model for cloning
     *          another.
     */
     ...
     * @param timeZone Which timeZone do you want to know the date for that UTC
     *                 time. e.g. TimeZone.getDefault(), new TimeZone("GMT")
     */
     ...
     *
     * @param timeZone We consider this BigDate to have an implied time of 0:00
     *                 in this timeZone.
     *
     ...
     *
     * @see <a href="http://www.pip.dknet.dk/~pip10160/calendar.faq3.txt">Calendar
     *      FAQ</a>
     */
     ...
     * TimeZone.
     *
     * @param utcTimestamp milliseconds since 1970 in UTC time. E.g.
     *                     Date.getTime
    ...
    public String toString()
        ...
        if ( -999 <= yyyy && yyyy <= 9999 )
            {
            result = StringTools.toLZ( yyyy, 4 );
            }
        else
            {
        ...
        result +=
                "-" + StringTools.toLZ( mm, 2 ) + "-" + StringTools.toLZ( dd,
                                                                          2 );
        return result;
        }// end toString
