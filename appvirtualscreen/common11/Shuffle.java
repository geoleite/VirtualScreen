...
// -------------------------- PUBLIC STATIC METHODS --------------------------
    ...
    /**
     * Works much like Collections.shuffle. Randomly permutes the specified list
     * using a default source of randomness.  All permutations occur with
    ...
    /**
     * This method uses the same technique as Collections.shuffle, but is
     * somewhat simpler with direct array access. Randomly permute the specified
     * list using the specified source of randomness.  All permutations occur
     * with equal likelihood assuming that the source of randomness is fair.<p>
     * <p/>
